...
<div id="main">
    ...
    <div class="page-heading row my-0">
        <div class="col-12 col-lg-10"><h3>User Dashboard</h3></div>
        <div class="card col-4 col-lg-2" data-bs-toggle="modal" data-bs-target="#default">
            <div class="card-body py-2 px-4">
                <div class="place-content-evenly" >
                    <div class="flex items-center avatar">
                        <img class="rounded-full w-3" src="{{ URL::to('/images/'. Auth::user()->avatar) }}" alt="{{ Auth::user()->avatar }}">
                        <div class=" px-2 font-bold">{{ Auth::user()->firstname }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        ...
                        <div class="px-4">
                            <button class='btn btn-block btn-light-primary font-bold mt-1'>Start
                                Conversation</button>
                        </div>
                    </div>
                </div>
