...
class FormController extends Controller
{
    ...
    /** end form input full crud */

    public function formCheckbox()
    {
        return view('form.formcheckbox');
    }

    /** save record */
    public function checkboxSaveRecord(Request $request) 
    {
        try {
            $question = new FormCheckbox();
            ...
            Toastr::error('Question added fail :)','Error');
            return redirect()->back();
        }
    }
}
